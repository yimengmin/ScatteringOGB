...
dataset = OGBNDataset(dataset_name=dataset_name)
x = dataset.x
...
train_idx, val_idx, test_idx = dataset.splitted_idx["train"], dataset.splitted_idx["valid"], dataset.splitted_idx["test"]
edge_index = dataset.whole_graph.edge_index
